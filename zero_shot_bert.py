...
hypothesis = "Force was used during the burglary"

for i, mo in enumerate(MO_list):
    # run through model pre-trained on MNLI
    x = tokenizer.encode(
        mo, hypothesis, return_tensors="pt", truncation_strategy="only_first"
    )
    ...
    print(
        f"the prob that the label is true is: {prob_label_is_true}. The true value is {mo_list_force[i]}"
    )
